...
This mechanism has been integrated into Bitcore-Node-BitcoinGem which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoingempay/insight-api-bitcoingem#web-socket-api](https://github.com/bitcoingempay/insight-api-bitcoingem#web-socket-api)
* API: [https://github.com/bitcoingempay/insight-api-bitcoingem#instantsend-transactions](https://github.com/bitcoingempay/insight-api-bitcoingem#instantsend-transactions)
