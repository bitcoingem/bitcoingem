...
EXPECTED_HOLDER_NAMES = [
    ...
    "The BitcoinGem Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a BitcoinGem Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinGem Core developers'
...
Arguments:
    <base_directory> - The base directory of BitcoinGem Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BitcoinGem Core repository.
"""
