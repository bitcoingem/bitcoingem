/* src/config/bitcoingem-config.h.  Generated from bitcoingem-config.h.in by configure.  */
/* src/config/bitcoingem-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BGEM_CONFIG_H

#define BGEM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitcoinGem Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitcoinGem Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitcoingempay/bitcoingem/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinGem Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinGem Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoingemcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoingem.org/"
