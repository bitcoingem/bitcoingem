...
#define BOOST_TEST_MODULE BitcoinGem Test Suite

#include "test_bitcoingem.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitcoingem_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
