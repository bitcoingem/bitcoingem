...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner BitcoinGem address\n"
            "  payee          - Print the masternode payout BitcoinGem address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting BitcoinGem address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitcoingem",               "masternode",             &masternode,             true,  {} },
    { "bitcoingem",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitcoingem",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "bitcoingem",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
