...
2. run bitcoingemd with -printalert or -sendalert like this:
   /path/to/bitcoingemd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitcoingem.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitcoinGem Core:0.12.0.58/"));
