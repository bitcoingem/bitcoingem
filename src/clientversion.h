...
//! These need to be macros, as clientversion.cpp's and bitcoingem*-res.rc's voodoo requires it
...
/**
 * bitcoingemd-res.rc includes this file, but it cannot cope with real c++ code.
