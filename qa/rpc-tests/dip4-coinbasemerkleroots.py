...
from test_framework.test_framework import BitcoinGemTestFramework
...
class LLMQCoinbaseCommitmentsTest(BitcoinGemTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BitcoinGemTestFramework doesn't support this atm)
