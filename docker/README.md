...
official/supported Docker Images found at https://hub.docker.com/r/bitcoingempay/bitcoingemd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitcoingempay/bitcoingemd-develop/ when changing the above text**